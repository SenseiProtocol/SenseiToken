...
contract Sensei is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        _rOwned[0x83A49af14B243c609F8e7f09dab13065bf4c826A] = _rTotal.div(100).mul(3); // Wallet future development - 3%
        _rOwned[0x7cb8Bd57826c00672CFd03412468B7FBeF63279f] = _rTotal.div(10000).mul(553); // Wallet future team - 5.53%
        _rOwned[0xa3448570Ac5b48e7C40D2356e7dE8aCc9efe2C27] = _rTotal.div(1000).mul(84); // Wallet future advisor - 8.4%
        _rOwned[0x055AC601eAa45EAc36466A67f535A02A6481Ba73] = _rTotal.div(100).mul(12); // Wallet future marketing - 12%
        _rOwned[0xfED3051B554A9FCf8eDFbAd7a597f54c7d61814c] = _rTotal.div(100); // Team member Anubis - 1%
        _rOwned[0xBeC16697926f43a9c6de7817a8BCce335F366BcD] = _rTotal.div(1000).mul(5); // Team member Dorian - 0.5%
        _rOwned[0xa6Ec04eBc379F2f663F410eB445584f7b0a5f885] = _rTotal.div(1000).mul(5); // Team member Dorian - 0.5%
        _rOwned[0xaBd5fe6a52F8a33c58a19254D6A1fcF4709C2526] = _rTotal.div(1000).mul(4); // Team member Antonin - 0.4%
        _rOwned[0x3184bF7c88b72C470EC61EB8aeC7bD4278649986] = _rTotal.div(1000).mul(4); // Team member Antonin - 0.4%
        _rOwned[0x1DfEDFEdfC4C428A0F9850ea89430CD906C4E69e] = _rTotal.div(1000).mul(5); // Team member Vincent - 0.5%
        _rOwned[0x1FDe37b4fE004A28e57f7DCDfbCD8FfaB9a2b28C] = _rTotal.div(1000).mul(5); // Team member Vincent - 0.5%
        _rOwned[0x17aFC584ACb4Af95904209d56c100c1FCfF9AD19] = _rTotal.div(1000).mul(2); // Team member Tim - 0.2%
        _rOwned[0x986c1EF8C97190A3b65f17DB3b00732b45389D47] = _rTotal.div(1000); // Team member Omar - 0.1%
        _rOwned[0x07E9732929e78a896bDcc568332a72929C0765Cf] = _rTotal.div(10000); // Team member Enzo - 0.01%
        _rOwned[0x2b055675cB9156D1e393a2BD8a89E0960EF5A061] = _rTotal.div(10000); // Team member Alan - 0.01%
        _rOwned[0x2c7c3D35A800353219dF66cAa46F5Fa4d491AF5e] = _rTotal.div(10000); // Team member CryptoMood - 0.01%
        _rOwned[0xbfe92F7AF15441eBB41aC49902Bf1C073EA05285] = _rTotal.div(10000).mul(25); // Team member Philippe - 0.25%
        _rOwned[0xD6cC5aD9440E0339F2C7b7D192633bD0Fb1D8EA0] = _rTotal.div(10000).mul(25); // Team member Philippe - 0.25%
        _rOwned[0x10cD8079755bC23b7E644F60627478e62E8817D5] = _rTotal.div(1000).mul(5); // Team member Flo - 0.5%
        _rOwned[0xb79B40D3798A84509Cb802adDD24D2422C9B73C6] = _rTotal.div(1000).mul(5); // Team member Flo - 0.5%
        _rOwned[0xfAE1a77863339c650306edDd72441485bf8b5cEB] = _rTotal.div(1000).mul(3); // Team member Elodie - 0.3%
        _rOwned[0x38BFcf71AD5ec5123092E561Cc9DfC36769cDC81] = _rTotal.div(1000); // Team member - 0.1%
        _rOwned[0x2caa27521590185C3482fD62B7bF9084034f1131] = _rTotal.div(10000).mul(6504); // Supply left 65,04% - Owner
        ...
        emit Transfer(address(0), 0x83A49af14B243c609F8e7f09dab13065bf4c826A, _tTotal.div(100).mul(3)); // Wallet future development - 3%
        emit Transfer(address(0), 0x7cb8Bd57826c00672CFd03412468B7FBeF63279f, _tTotal.div(10000).mul(553)); // Wallet future team - 5.53%
        emit Transfer(address(0), 0xa3448570Ac5b48e7C40D2356e7dE8aCc9efe2C27, _tTotal.div(1000).mul(84)); // Wallet future advisor - 8.4%
        emit Transfer(address(0), 0x055AC601eAa45EAc36466A67f535A02A6481Ba73, _tTotal.div(100).mul(12)); // Wallet future marketing - 12%
        ...
        emit Transfer(address(0), 0x2c7c3D35A800353219dF66cAa46F5Fa4d491AF5e, _tTotal.div(10000)); // Team member - 0.01%
        ...
        emit Transfer(address(0), 0x2caa27521590185C3482fD62B7bF9084034f1131, _tTotal.div(10000).mul(6504)); // Supply left 65,04% - Owner
    }
